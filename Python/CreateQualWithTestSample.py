...
# XML representing the qual test
test_xml = open("qualtest001.xml", "r").read()

# XML representing the expected answer
answer_key_xml = open("qualanswerkey001.xml", "r").read()

qual_id = '3HK1RLG9AVDBRYM2UG6QT2AX8NIYWW'
#        Name="qual with test 001",
#        Keywords="",

#response = client.update_qualification_type(
response = client.create_qualification_type(
        Name="trenton qual with test 003",
        Keywords="",
#        QualificationTypeId=qual_id,
        Description="qual with test 002 description",
        QualificationTypeStatus='Active',
#        RetryDelayInSeconds=61,
#        Test=test_xml,
...
print("updated qual {}".format(response['QualificationType']['QualificationTypeId']))
...
response = client.create_hit(
    ...
    Title='Trenton -- answer a simple question with a test 3',
